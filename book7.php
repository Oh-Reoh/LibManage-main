...
<body>
	...
	<section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"><a href="booklist(Librarian).html"> Books </a>>> Goldilocks and the three bears</h1>
            <div class="data">
                <!-- Left Column -->
                        ...
                        <div class="book-info-content">
                            ...
                            <div class="book-details">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="value">Fairy tale, Children's literature</span>
                                </div>
                                <div class="detail-item">
                            ...
                            <div class="book-image">
                                <img src="images/Goldi_info.png" alt="Book Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-column">
                    <div class="content-data book-overview">
                        <div class="book-overview-content">
                            <!-- Book Cover Image -->
                            <img src="images/Goldi_overview.png" alt="The Wizard of Oz Cover" class="book-cover">
                    
                            <!-- Book Title and Author -->
                            <h2 class="book-title">Goldilocks and the three bears</h2>
                            <p class="book-author">James Marshall</p>
