...
<body>
	...
	<section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"><a href="booklist(Librarian).html"> Books </a>>> Stranger Things</h1>
            <div class="data">
                <!-- Left Column -->
                        ...
                        <div class="book-info-content">
                            ...
                            <div class="book-details">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="value">Horror fiction, Science fiction</span>
                                </div>
                                <div class="detail-item">
                            ...
                            <div class="book-image">
                                <img src="images/SThings_info.png" alt="Book Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-column">
                    <div class="content-data book-overview">
                        <div class="book-overview-content">
                            <!-- Book Cover Image -->
                            <img src="images/SThings_overview.png" alt="The Wizard of Oz Cover" class="book-cover">
                    
                            <!-- Book Title and Author -->
                            <h2 class="book-title">Stranger Things</h2>
                            <p class="book-author">Matt and Ross Duffer</p>
