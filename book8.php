...
<body>
	...
	<section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"><a href="booklist(Librarian).html"> Books </a>>> Pinocchio</h1>
            <div class="data">
                <!-- Left Column -->
                        ...
                        <div class="book-info-content">
                            ...
                            <div class="book-details">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="value">Novel, Children's literature, Fantasy</span>
                                </div>
                                <div class="detail-item">
                            ...
                            <div class="book-image">
                                <img src="images/Pino_info.png" alt="Book Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-column">
                    <div class="content-data book-overview">
                        <div class="book-overview-content">
                            <!-- Book Cover Image -->
                            <img src="images/Pino_overview.png" alt="The Wizard of Oz Cover" class="book-cover">
                    
                            <!-- Book Title and Author -->
                            <h2 class="book-title">Pinocchio</h2>
                            <p class="book-author">Carlo Collodi</p>
                    
                            <!-- Book Description -->
                            <p class="book-description">
                                Pinocchio, a puppet carved by Geppetto, dreams of becoming a real boy but repeatedly strays from the path of goodness, giving in to temptation, telling lies, and causing mischief. Through his adventures and mistakes, he learns that love and responsibility come before pleasure and play. Ultimately, he becomes a real boy after understanding these lessons. The story, a timeless classic, has been widely adapted and remains an iconic figure in children's literature.
                            </p>
