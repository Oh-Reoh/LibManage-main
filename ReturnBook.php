...
if (isset($_POST['submit'])) {
    ...
    $stmtLogs = $conn->prepare("INSERT INTO tbl_bookinfo_logs 
        (bookname, author, returndate, borrowedby, requestby, bookisinuse, isrequest) 
        VALUES (?, ?, ?, ?, ?, ?, ?)");

    $stmtLogs2 = $conn->prepare("UPDATE tbl_bookinfo SET isinuse = 0 WHERE bookname = ? and isinuse = 1");
