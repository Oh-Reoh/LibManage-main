...
<body>
	...
	<section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"><a href="booklist(Librarian).html"> Books </a>>> The Lord of the Rings</h1>
            <div class="data">
                <!-- Left Column -->
                        ...
                        <div class="book-info-content">
                            ...
                            <div class="book-details">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="value">Heroic fantasy, Adventure fiction, Fantasy Fiction</span>
                                </div>
                                <div class="detail-item">
                            ...
                            <div class="book-image">
                                <img src="images/Lor_info.png" alt="Book Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-column">
                    <div class="content-data book-overview">
                        <div class="book-overview-content">
                            <!-- Book Cover Image -->
                            <img src="images/Lor_overview.png" alt="The Wizard of Oz Cover" class="book-cover">
                    
                            <!-- Book Title and Author -->
                            <h2 class="book-title">The Lord of the Rings</h2>
                            <p class="book-author">J.R.R. Tolkien</p>
                    
                            <!-- Book Description -->
                            <p class="book-description">
                                Bilbo Baggins discovered the One Ring, a powerful artifact forged by the Dark Lord Sauron, who was forced into hiding when it was lost. Now, Sauron’s power is growing again, and he seeks to reclaim the Ring to complete his domination. The only way to stop him is to destroy it in the fires of Mordor, and the task falls to Bilbo’s heir, Frodo, who is determined to see it through, no matter the cost.
                            </p>
