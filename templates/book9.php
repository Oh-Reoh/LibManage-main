...
<body>
	...
	<section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"><a href="booklist(Librarian).html"> Books </a>>> Peter Pan</h1>
            <div class="data">
                <!-- Left Column -->
                        ...
                        <div class="book-info-content">
                            ...
                            <div class="book-details">
                                <div class="detail-item">
                                    ...
                                    <span class="value">1911</span>
                                </div>
                                <div class="detail-item">
                                    <span class="label">Genre:</span>
                                    <span class="value">Novel, Children's literature, Fantasy, Young adult literature</span>
                                </div>
                                <div class="detail-item">
                            ...
                            <div class="book-image">
                                <img src="images/Ppan_info.png" alt="Book Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-column">
                    <div class="content-data book-overview">
                        <div class="book-overview-content">
                            <!-- Book Cover Image -->
                            <img src="images/Ppan_overview.png" alt="The Wizard of Oz Cover" class="book-cover">
                    
                            <!-- Book Title and Author -->
                            <h2 class="book-title">Peter Pan</h2>
                            <p class="book-author">J.M. Barrie</p>
                    
                            <!-- Book Description -->
                            <p class="book-description">
                                "Peter Pan" by J.M. Barrie tells the story of a boy who never grows up. He takes the Darling children to Neverland, where they have adventures with pirates, mermaids, and the Lost Boys. While Wendy longs to return home, Peter stays in Neverland, forever young. The story explores themes of childhood, adventure, and growing up, and remains a beloved classic.
                            </p>
