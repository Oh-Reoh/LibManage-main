...
<body>
	...
	<section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"><a href="booklist(Librarian).html"> Books </a>>> The Lion king</h1>
            <div class="data">
                <!-- Left Column -->
                        ...
                        <div class="book-info-content">
                            ...
                            <div class="book-details">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="value">Adventure, Children's literature, Drama</span>
                                </div>
                                <div class="detail-item">
                            ...
                            <div class="book-image">
                                <img src="images/Lk_info.png" alt="Book Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-column">
                    <div class="content-data book-overview">
                        <div class="book-overview-content">
                            <!-- Book Cover Image -->
                            <img src="images/Lk_overview.png" alt="The Wizard of Oz Cover" class="book-cover">
                    
                            <!-- Book Title and Author -->
                            <h2 class="book-title">The Lion king</h2>
                            <p class="book-author">Walt Disney Company</p>
                    
                            <!-- Book Description -->
                            <p class="book-description">
                                In this Disney animated film, a young lion prince is tricked by his evil uncle, who orchestrates the death of his father to take the throne. After fleeing in guilt, the prince grows up in exile and eventually returns to reclaim his homeland, with the help of two unlikely friends.
                            </p>
