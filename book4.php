...
<body>
	...
	<section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"><a href="booklist(Librarian).html"> Books </a>>> Life of Pi</h1>
            <div class="data">
                <!-- Left Column -->
                    ...
                    <div class="content-data book-information">
                        ...
                        <div class="book-info-content">
                            ...
                            <div class="book-image">
                                <img src="images/Lip_info.png" alt="Book Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-column">
                    <div class="content-data book-overview">
                        <div class="book-overview-content">
                            <!-- Book Cover Image -->
                            <img src="images/Lip_overview.png" alt="The Wizard of Oz Cover" class="book-cover">
                    
                            <!-- Book Title and Author -->
                            <h2 class="book-title">Life of Pi</h2>
